...
var OUT = "/mnt/user-data/outputs/SeaHype Marine Biology Education.html";
...
setTimeout(function () {
  try {
    ...
    var SRC = {
      noaa:1,noaaoe:1,noaafish:1,noaaedu:1,coral:1,pmel:1,si:1,mbari:1,whoi:1,
      iucn:1,worms:1,nasa:1,usgs:1,eol:1,natgeo:1,fao:1
    };
    ...
    setTimeout(function () {
      ...
      ok(txt.indexOf("dive") > -1 || txt.indexOf("Welcome") > -1 || txt.indexOf("SeaHype") > -1 || txt.length > 80, "mounted content looks empty");
